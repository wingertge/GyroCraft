...
import gyrocraft.block.CustomItem;
import gyrocraft.config.ConfigHelper;
import gyrocraft.config.ConfigHolder;
import gyrocraft.init.ModBlocks;
import gyrocraft.init.ModItemGroups;
import gyrocraft.item.ModdedSpawnEggItem;
 ...
 * @author Cadiboo
 */
@EventBusSubscriber(modid = GyroCraft.MODID, bus = EventBusSubscriber.Bus.MOD)
public final class ModEventSubscriber {

	private static final Logger LOGGER = LogManager.getLogger(GyroCraft.MODID + " Mod Event Subscriber");
	...
	public static void onRegisterItems(final RegistryEvent.Register<Item> event) {
		...
		ModBlocks.BLOCKS.getEntries().stream()
				...
				.filter(block -> !(block instanceof CustomItem))
