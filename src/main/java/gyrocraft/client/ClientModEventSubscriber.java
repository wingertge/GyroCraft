...
import gyrocraft.client.gui.ElectricFurnaceScreen;
import gyrocraft.client.gui.HeatCollectorScreen;
import gyrocraft.client.gui.ModFurnaceScreen;
import gyrocraft.client.render.entity.WildBoarRenderer;
import gyrocraft.client.render.tileentity.ElectricFurnaceTileEntityRenderer;
import gyrocraft.client.render.tileentity.MiniModelTileEntityRenderer;
import gyrocraft.init.*;
 ...
 * @author Cadiboo
 */
@EventBusSubscriber(modid = GyroCraft.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public final class ClientModEventSubscriber {

	private static final Logger LOGGER = LogManager.getLogger(GyroCraft.MODID + " Client Mod Event Subscriber");
	...
	public static void onFMLClientSetupEvent(final FMLClientSetupEvent event) {
		RenderTypeLookup.setRenderLayer(ModBlocks.CANOLA.get(), RenderType.cutoutMipped());
