...
import gyrocraft.container.ElectricFurnaceContainer;
...
public class ElectricFurnaceScreen extends ContainerScreen<ElectricFurnaceContainer> {
	...
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(GyroCraft.MODID, "textures/gui/container/electric_furnace.png");
	...
	public void render(final int mouseX, final int mouseY, final float partialTicks) {
		...
		if (arrowHovered && tileEntity.maxSmeltTime > 0) {
			String tooltip = new TranslationTextComponent(
					"gui." + GyroCraft.MODID + ".smeltTimeProgress",
