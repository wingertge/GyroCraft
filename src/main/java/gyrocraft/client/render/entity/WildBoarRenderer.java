package gyrocraft.client.render.entity;

import gyrocraft.GyroCraft;
import gyrocraft.client.render.entity.layer.WildBoarSaddleLayer;
import gyrocraft.entity.WildBoarEntity;
...
public class WildBoarRenderer extends MobRenderer<WildBoarEntity, PigModel<WildBoarEntity>> {
	...
	private static final ResourceLocation WILD_BOAR_TEXTURE = new ResourceLocation(GyroCraft.MODID, "textures/entity/wild_boar/wild_boar.png");
