package gyrocraft.client.render.entity.layer;
...
public class WildBoarSaddleLayer extends LayerRenderer<WildBoarEntity, PigModel<WildBoarEntity>> {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(GyroCraft.MODID, "textures/entity/wild_boar/wild_boar_saddle.png");
