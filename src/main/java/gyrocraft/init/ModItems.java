...
public final class ModItems {
	...
	public static final DeferredRegister<Item> ITEMS = new DeferredRegister<>(ForgeRegistries.ITEMS, GyroCraft.MODID);
	...
	//public static final RegistryObject<CanolaSeedsItem> CANOLA_SEEDS = ITEMS.register("canola_seeds", () -> new CanolaSeedsItem(new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
}
