package gyrocraft.init;

import gyrocraft.GyroCraft;
import gyrocraft.tileentity.ElectricFurnaceTileEntity;
import gyrocraft.tileentity.HeatCollectorTileEntity;
import gyrocraft.tileentity.MiniModelTileEntity;
import gyrocraft.tileentity.ModFurnaceTileEntity;
...
public final class ModTileEntityTypes {
	...
	public static final DeferredRegister<TileEntityType<?>> TILE_ENTITY_TYPES = new DeferredRegister<>(ForgeRegistries.TILE_ENTITIES, GyroCraft.MODID);
