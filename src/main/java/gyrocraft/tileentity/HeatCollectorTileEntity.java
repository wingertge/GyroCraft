package gyrocraft.tileentity;

import gyrocraft.ModUtil;
import gyrocraft.block.HeatCollectorBlock;
...
public class HeatCollectorTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	public void tick() {
		...
		final int transferAmountPerTick = GyroCraftConfig.heatCollectorTransferAmountPerTick;
